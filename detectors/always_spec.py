#!/usr/bin/env python3
"""Every task resolves the spec against the repo.

Unconditional: the spec and the code drift without any file a task touched
changing, and the last three times somebody asked whether everything had been
checked, the honest answer was no.
"""
import argparse, sys
def main() -> int:
    ...
    print("V4-CLAIM: kind=spec-coverage")
    return 0
